"""
02_prepare_hut_eqaly.py — eQALY Value Factor script: hut

Pipeline
────────
  Stage 1  Configuration  config.get_indicator_config("hut")
  Stage 2  Data Loading   pipeline.load_sheet()
  Stage 3  Extraction     pipeline.extract_hut()
...
Outputs
───────
  output/02_eqaly_hut.h5     HDF5: keys "coefficient" and "unit"
  output/02_eqaly_hut.xlsx   Excel: "Coefficients", "Units", "Pathway data"
